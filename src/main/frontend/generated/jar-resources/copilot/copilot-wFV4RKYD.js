...
var vi = Object.assign, Ht = Object.getOwnPropertyDescriptor, _ = Object.defineProperty, or = Object.prototype, Wt = [];
Object.freeze(Wt);
var Xr = {};
Object.freeze(Xr);
...
function $a(e) {
  ...
  return r.length ? [].concat(t, r.filter(function(n) {
    return or.propertyIsEnumerable.call(e, n);
  })) : t;
}
...
function H(e, t) {
  return or.hasOwnProperty.call(e, t);
}
...
function Ct(e, t, r) {
  if (H(e, ie) || lr(e, ie, he({}, e[ie])), process.env.NODE_ENV !== "production" && Xt(r) && !H(e[ie], t)) {
...
function ao(e, t, r) {
  if (process.env.NODE_ENV !== "production" && !Xt(t) && H(e[ie], r)) {
...
var g = /* @__PURE__ */ Symbol("mobx administration"), me = /* @__PURE__ */ function() {
  ...
  return t.onBO = function() {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isBeingObservedMask_, n);
    }
  }, {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isPendingUnobservationMask_, n);
    }
  }, {
    key: "diffValue",
    get: function() {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.diffValueMask_, n === 1);
    }
  }]);
}();
...
function De(e, t, r) {
  return wt(e) ? e : Array.isArray(e) ? C.array(e, {
    ...
    name: r
  }) : typeof e == "function" && !Te(e) && !yt(e) ? mi(e) ? Je(e) : bt(r, e) : e;
}
function lo(e, t, r) {
  if (e == null || tt(e) || gr(e) || be(e) || Y(e))
    return e;
  if (Array.isArray(e))
    return C.array(e, {
      name: r,
...
function ho(e, t) {
  process.env.NODE_ENV !== "production" && cr(t, ["method", "field"]);
  var r = t.kind, n = t.name, i = t.addInitializer, a = this, o = function(c) {
    var d, u, h, v;
    return Ne((d = (u = a.options_) == null ? void 0 : u.name) != null ? d : n.toString(), c, (h = (v = a.options_) == null ? void 0 : v.autoAction) != null ? h : !1);
  };
  if (r == "field")
    return function(l) {
      var c, d = l;
      return Te(d) || (d = o(d)), (c = a.options_) != null && c.bound && (d = d.bind(this), d.isMobxAction = !0), d;
    };
  if (r == "method") {
    var s;
    return Te(e) || (e = o(e)), (s = this.options_) != null && s.bound && i(function() {
...
function Ei(e, t, r, n, i) {
  var a, o, s, l, c, d, u;
  i === void 0 && (i = p.safeDescriptors), vo(e, t, r, n);
  var h = n.value;
...
function go(e, t, r, n) {
  ...
  if (n === e.target_)
    return this.extend_(e, t, r, !1) === null ? 0 : 2;
  if ((i = this.options_) != null && i.bound && (!H(e.target_, t) || !yt(e.target_[t])) && this.extend_(e, t, r, !1) === null)
    return 0;
  if (yt(r.value))
    return 1;
...
function bo(e, t) {
  var r;
  process.env.NODE_ENV !== "production" && cr(t, ["method"]);
...
function xo(e, t, r, n) {
  return Eo(e, this, t, r), e.defineComputedProperty_(t, he({}, this.options_, {
    get: r.get,
    set: r.set
  }), n);
}
function Oo(e, t) {
  process.env.NODE_ENV !== "production" && cr(t, ["getter"]);
  var r = this, n = t.name, i = t.addInitializer;
  return i(function() {
    var a = et(this)[g], o = he({}, r.options_, {
      get: e,
      context: this
    });
    o.name || (o.name = process.env.NODE_ENV !== "production" ? a.name_ + "." + n.toString() : "ObservableObject." + n.toString()), a.values_.set(n, new K(o));
  }), function() {
...
function Ao(e, t) {
  ...
  function o(s, l) {
    var c, d, u = et(s)[g], h = new Se(l, (c = (d = r.options_) == null ? void 0 : d.enhancer) != null ? c : De, process.env.NODE_ENV !== "production" ? u.name_ + "." + i.toString() : "ObservableObject." + i.toString(), !1);
    u.values_.set(i, h), a.add(s);
  }
  if (n == "accessor")
    return {
      get: function() {
...
function No(e, t, r, n) {
  var i, a;
  if (r.get)
    return pr.make_(e, t, r, n);
  if (r.set) {
    var o = Te(r.set) ? r.set : Ne(t.toString(), r.set);
...
var Ir = /* @__PURE__ */ ur(Io), Mo = /* @__PURE__ */ ur(zo, {
  enhancer: dr
}), jo = /* @__PURE__ */ ur(Uo, {
  enhancer: lo
}), Ro = /* @__PURE__ */ ur(Lo, {
...
function It(e) {
  return e.deep === !0 ? De : e.deep === !1 ? dr : Bo(e.defaultDecorator);
}
function qo(e) {
  var t;
...
var Ko = {
  ...
  deep: Pi,
  struct: /* @__PURE__ */ $(Ro)
}, C = /* @__PURE__ */ vi(Di, Ko), Ni = "computed", Fo = "computed.struct", zr = /* @__PURE__ */ Yr(Ni), Zo = /* @__PURE__ */ Yr(Fo, {
  equals: Xe.structural
}), pr = function(t, r) {
  if (At(r))
    return zr.decorate_20223_(t, r);
  if (Pe(r))
    return Ct(t, r, zr);
  if (D(t))
    return $(Yr(Ni, t));
  ...
  var n = D(r) ? r : {};
  return n.get = t, n.name || (n.name = t.name || ""), new K(n);
};
Object.assign(pr, zr);
pr.struct = /* @__PURE__ */ $(Zo);
var fn, hn, Jt = 0, Ho = 1, Wo = (fn = (hn = /* @__PURE__ */ Ht(function() {
}, "name")) == null ? void 0 : hn.configurable) != null ? fn : !1, vn = {
  value: "action",
  configurable: !0,
  writable: !1,
  enumerable: !1
...
function Ne(e, t, r, n) {
  ...
  function i() {
    return Vi(e, r, t, n || this, arguments);
  }
  return i.isMobxAction = !0, i.toString = function() {
    return t.toString();
  }, Wo && (vn.value = e, _(i, "name", vn)), i;
}
...
function Jo(e) {
  Jt !== e.actionId_ && f(30), Jt = e.parentActionId_, e.error_ !== void 0 && (p.suppressReactionErrors = !0), hr(e.prevAllowStateChanges_), ft(e.prevAllowStateReads_), q(), e.runAsAction_ && oe(e.prevDerivation_), process.env.NODE_ENV !== "production" && e.notifySpy_ && U({
...
var Yo = "create", Se = /* @__PURE__ */ function(e) {
  ...
  return r.dehanceValue = function(i) {
    ...
    if (i = this.prepareNewValue_(i), i !== p.UNCHANGED) {
      ...
      process.env.NODE_ENV !== "production" && o && z({
        ...
        newValue: i,
        oldValue: a
      }), this.setNewValue_(i), process.env.NODE_ENV !== "production" && o && U();
    }
    ...
    var a = this.value_;
    this.value_ = i, this.reportChanged(), W(this) && X(this, {
      type: Z,
      object: this,
      newValue: i,
      oldValue: a
  ...
  return t.onBecomeStale_ = function() {
    ...
    this.observers_.size === 0 && !this.keepAlive_)
      Ur(this) && (this.warnAboutUntrackedRead_(), R(), this.value_ = this.computeValue_(!1), q());
    else if (Mi(this), Ur(this)) {
    ...
    return o && (this.value_ = a, process.env.NODE_ENV !== "production" && P() && Ve({
    ...
    var i = fr(!1), a;
    if (n)
      a = Ti(this, this.derivation, this.scope_);
    ...
    this.keepAlive_ || (Lr(this), this.value_ = void 0, process.env.NODE_ENV !== "production" && this.isTracing_ !== B.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' was suspended and it will recompute on the next access."));
    ...
    process.env.NODE_ENV !== "production" && (this.isTracing_ !== B.NONE && console.log("[mobx.trace] Computed value '" + this.name_ + "' is being read outside a reactive context. Doing a full recompute."), (typeof this.requiresReaction_ == "boolean" ? this.requiresReaction_ : p.computedRequiresReaction) && console.warn("[mobx] Computed value '" + this.name_ + "' is being read outside a reactive context. Doing a full recompute."));
  }, t.toString = function() {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isComputingMask_, n);
    }
  }, {
    key: "isRunningSetter",
    get: function() {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isRunningSetterMask_, n);
    }
  }, {
    key: "isBeingObserved",
    get: function() {
...
K.diffValueMask_ = 16;
var vr = /* @__PURE__ */ Ue("ComputedValue", K), w;
(function(e) {
...
}, xr = !0, p = /* @__PURE__ */ function() {
  var e = /* @__PURE__ */ Wr();
  return e.__mobxInstanceCount > 0 && !e.__mobxGlobals && (xr = !1), e.__mobxGlobals && e.__mobxGlobals.version !== new wr().version && (xr = !1), xr ? e.__mobxGlobals ? (e.__mobxInstanceCount += 1, e.__mobxGlobals.UNCHANGED || (e.__mobxGlobals.UNCHANGED = {}), e.__mobxGlobals) : (e.__mobxInstanceCount = 1, e.__mobxGlobals = /* @__PURE__ */ new wr()) : (setTimeout(function() {
    f(35);
  }, 1), new wr());
}();
function es(e, t) {
...
function q() {
  if (--p.inBatch === 0) {
    ...
    for (var e = p.pendingUnobservations, t = 0; t < e.length; t++) {
      var r = e[t];
      r.isPendingUnobservation = !1, r.observers_.size === 0 && (r.isBeingObserved && (r.isBeingObserved = !1, r.onBUO()), r instanceof K && r.suspend_());
    }
...
function ji(e) {
  e.lowestObserverState_ !== w.STALE_ && (e.lowestObserverState_ = w.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === w.UP_TO_DATE_ && (process.env.NODE_ENV !== "production" && t.isTracing_ !== B.NONE && Ri(t, e), t.onBecomeStale_()), t.dependenciesState_ = w.STALE_;
  }));
}
function ts(e) {
  e.lowestObserverState_ !== w.STALE_ && (e.lowestObserverState_ = w.STALE_, e.observers_.forEach(function(t) {
    t.dependenciesState_ === w.POSSIBLY_STALE_ ? (t.dependenciesState_ = w.STALE_, process.env.NODE_ENV !== "production" && t.isTracing_ !== B.NONE && Ri(t, e)) : t.dependenciesState_ === w.UP_TO_DATE_ && (e.lowestObserverState_ = w.UP_TO_DATE_);
  }));
}
function rs(e) {
...
` + (e instanceof K ? e.derivation.toString().replace(/[*]\//g, "/") : "") + `
...
var ee = /* @__PURE__ */ function() {
  function e(r, n, i, a) {
    r === void 0 && (r = process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction"), this.name_ = void 0, this.onInvalidate_ = void 0, this.errorHandler_ = void 0, this.requiresObservable_ = void 0, this.observing_ = [], this.newObserving_ = [], this.dependenciesState_ = w.NOT_TRACKING_, this.runId_ = 0, this.unboundDepsCount_ = 0, this.flags_ = 0, this.isTracing_ = B.NONE, this.name_ = r, this.onInvalidate_ = n, this.errorHandler_ = i, this.requiresObservable_ = a;
  }
  var t = e.prototype;
  return t.onBecomeStale_ = function() {
    this.schedule_();
  }, t.schedule_ = function() {
    this.isScheduled || (this.isScheduled = !0, p.pendingReactions.push(this), Bi());
  }, t.runReaction_ = function() {
    if (!this.isDisposed) {
      R(), this.isScheduled = !1;
      var n = p.trackingContext;
      if (p.trackingContext = this, Ur(this)) {
        this.isTrackPending = !0;
        try {
          this.onInvalidate_(), process.env.NODE_ENV !== "production" && this.isTrackPending && P() && Ve({
            name: this.name_,
    ...
    if (!this.isDisposed) {
      R();
      var i = P(), a;
      process.env.NODE_ENV !== "production" && i && (a = Date.now(), z({
        name: this.name_,
        type: "reaction"
      })), this.isRunning = !0;
      var o = p.trackingContext;
      p.trackingContext = this;
      var s = Ti(this, n, void 0);
      p.trackingContext = o, this.isRunning = !1, this.isTrackPending = !1, this.isDisposed && Lr(this), qt(s) && this.reportExceptionInDerivation_(s.cause), process.env.NODE_ENV !== "production" && i && U({
        time: Date.now() - a
      }), q();
    }
    ...
    p.suppressReactionErrors ? process.env.NODE_ENV !== "production" && console.warn("[mobx] (error in reaction '" + this.name_ + "' suppressed, fix error of causing action below)") : console.error(a, n), process.env.NODE_ENV !== "production" && P() && Ve({
      type: "error",
      name: this.name_,
      message: a,
      error: "" + n
    ...
    this.isDisposed || (this.isDisposed = !0, this.isRunning || (R(), Lr(this), q()));
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isDisposedMask_, n);
    }
  }, {
    key: "isScheduled",
    get: function() {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isScheduledMask_, n);
    }
  }, {
    key: "isTrackPending",
    get: function() {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isTrackPendingMask_, n);
    }
  }, {
    key: "isRunning",
    get: function() {
    ...
    set: function(n) {
      this.flags_ = I(this.flags_, e.isRunningMask_, n);
    }
  }, {
    key: "diffValue",
    get: function() {
...
function U(e) {
  process.env.NODE_ENV !== "production" && Ve(e ? he({}, e, {
    type: "report-end",
    spyReportEnd: !0
  }) : os);
}
...
var _r = "action", ls = "action.bound", Ki = "autoAction", cs = "autoAction.bound", Fi = "<unnamed action>", Mr = /* @__PURE__ */ St(_r), ds = /* @__PURE__ */ St(ls, {
  bound: !0
}), jr = /* @__PURE__ */ St(Ki, {
  autoAction: !0
}), us = /* @__PURE__ */ St(cs, {
...
function Zi(e) {
  var t = function(n, i) {
    ...
    if (k(i))
      return Ne(n, i, e);
    if (At(i))
      return (e ? jr : Mr).decorate_20223_(n, i);
    if (Pe(i))
      return Ct(n, i, e ? jr : Mr);
    if (Pe(n))
      return $(St(e ? Ki : _r, {
        name: n,
        autoAction: e
...
function Nd(e) {
  return Vi(e.name || Fi, !1, e, this, void 0);
}
function Te(e) {
...
function Hi(e, t) {
  var r, n, i, a;
  t === void 0 && (t = Xr), process.env.NODE_ENV !== "production" && (k(e) || f("Autorun expects a function as first argument"), Te(e) && f("Autorun does not accept actions since actions are untrackable"));
...
function $r(e, t, r) {
  ...
  var o = (n = r.name) != null ? n : process.env.NODE_ENV !== "production" ? "Reaction@" + F() : "Reaction", s = Ce(o, r.onError ? fs(r.onError, t) : t), l = !r.scheduler && !r.delay, c = Wi(r), d = !0, u = !1, h, v = r.compareStructural ? Xe.structural : r.equals || Xe.default, m = new ee(o, function() {
    d || l ? O() : u || (u = !0, c(O));
  ...
  function O() {
    if (u = !1, !m.isDisposed) {
      ...
      m.track(function() {
        ...
        A = d || !v(h, je), h = je;
      }), (d && r.fireImmediately || !d && A) && s(h, G, m), d = !1;
    }
  }
...
var Or = /* @__PURE__ */ ki("flow"), ws = /* @__PURE__ */ ki("flow.bound", {
  bound: !0
  ...
  var n = t, i = n.name || "<unnamed flow>", a = function() {
    var s = this, l = arguments, c = ++ys, d = Ce(i + " - runid: " + c + " - init", n).apply(s, l), u, h = void 0, v = new Promise(function(m, O) {
      var A = 0;
      u = O;
      function G(N) {
        h = void 0;
      ...
      function it(N) {
        ...
        return N.done ? m(N.value) : (h = Promise.resolve(N.value), h.then(G, je));
      }
      G(void 0);
    });
    return v.cancel = Ce(i + " - runid: " + c + " - cancel", function() {
      try {
        h && mn(h);
...
function xs(e, t) {
  return e ? tt(e) || !!e[g] || Gr(e) || Yt(e) || vr(e) : !1;
}
function wt(e) {
...
function $e(e, t, r) {
  return process.env.NODE_ENV !== "production" && (!D(e) && !D(Object.getPrototypeOf(e)) && f("'makeAutoObservable' can only be used for classes that don't have a superclass"), tt(e) && f("makeAutoObservable can only be used on objects not already made observable")), D(e) ? Gi(e, e, t, r) : (Me(function() {
    ...
    if (!e[Er]) {
      ...
      a.delete("constructor"), a.delete(g), lr(i, Er, a);
    }
    e[Er].forEach(function(o) {
      return n.make_(
        o,
        // must pass "undefined" for { key: undefined }
        t && o in t ? t[o] : !0
...
var bn = "splice", Z = "update", As = 1e4, Ss = {
  get: function(t, r) {
    var n = t[g];
    return r === g ? n : r === "length" ? n.getArrayLength_() : typeof r == "string" && !isNaN(r) ? n.get_(parseInt(r)) : H(Qt, r) ? Qt[r] : t[r];
  },
  set: function(t, r, n) {
    var i = t[g];
  ...
  return t.dehanceValue_ = function(n) {
    ...
    if (n === void 0 ? n = 0 : n > s ? n = s : n < 0 && (n = Math.max(0, s + n)), arguments.length === 1 ? i = s - n : i == null ? i = 0 : i = Math.max(0, Math.min(i, s - n)), a === void 0 && (a = Wt), M(this)) {
      var l = j(this, {
        object: this.proxy_,
        type: bn,
        index: n,
    ...
    var o = !this.owned_ && P(), s = W(this), l = s || o ? {
      observableKind: "array",
      object: this.proxy_,
      type: Z,
      debugObjectName: this.atom_.name_,
    ...
    process.env.NODE_ENV !== "production" && o && z(l), this.atom_.reportChanged(), s && X(this, l), process.env.NODE_ENV !== "production" && o && U();
...
var Ns = {}, pe = "add", _t = "delete", $i = /* @__PURE__ */ function() {
  ...
  return t.has_ = function(n) {
    ...
    if (!a) {
      var o = a = new Se(this.has_(n), dr, process.env.NODE_ENV !== "production" ? this.name_ + "." + Vr(n) + "?" : "ObservableMap.key?", !1);
    ...
    if (this.has_(n)) {
      ...
      return process.env.NODE_ENV !== "production" && o && z(l), ae(function() {
        var c;
        i.keysAtom_.reportChanged(), (c = i.hasMap_.get(n)) == null || c.setNewValue_(!1);
        var d = i.data_.get(n);
        d.setNewValue_(void 0), i.data_.delete(n);
      }), s && X(this, l), process.env.NODE_ENV !== "production" && o && U(), !0;
    }
    return !1;
    ...
    if (i = a.prepareNewValue_(i), i !== p.UNCHANGED) {
      ...
      process.env.NODE_ENV !== "production" && o && z(l), a.setNewValue_(i), s && X(this, l), process.env.NODE_ENV !== "production" && o && U();
    }
    ...
    process.env.NODE_ENV !== "production" && o && z(l), s && X(this, l), process.env.NODE_ENV !== "production" && o && U();
  }, t.get = function(n) {
    ...
    var i = this;
    return ae(function() {
      for (var a = Vs(n), o = /* @__PURE__ */ new Map(), s = !1, l = Ze(i.data_.keys()), c; !(c = l()).done; ) {
        var d = c.value;
        if (!a.has(d)) {
          var u = i.delete(d);
          if (u)
      ...
      for (var v = Ze(a.entries()), m; !(m = v()).done; ) {
...
var Ts = {}, ea = /* @__PURE__ */ function() {
  function e(r, n, i) {
    var a = this;
    n === void 0 && (n = De), i === void 0 && (i = process.env.NODE_ENV !== "production" ? "ObservableSet@" + F() : "ObservableSet"), this.name_ = void 0, this[g] = Ts, this.data_ = /* @__PURE__ */ new Set(), this.atom_ = void 0, this.changeListeners_ = void 0, this.interceptors_ = void 0, this.dehancer = void 0, this.enhancer_ = void 0, this.name_ = i, k(Set) || f(22), this.enhancer_ = function(o, s) {
      return n(o, s, i);
    }, Me(function() {
  ...
  return t.dehanceValue_ = function(n) {
    ...
    if (!this.has(n)) {
      ...
      var o = process.env.NODE_ENV !== "production" && P(), s = W(this), l = s || o ? {
        observableKind: "set",
        debugObjectName: this.name_,
        type: pe,
        object: this,
      ...
      o && process.env.NODE_ENV !== "production" && z(l), s && X(this, l), o && process.env.NODE_ENV !== "production" && U();
    }
    return this;
  }, t.delete = function(n) {
    var i = this;
    ...
    if (this.has(n)) {
      ...
      return o && process.env.NODE_ENV !== "production" && z(l), ae(function() {
        i.atom_.reportChanged(), i.data_.delete(n);
      }), s && X(this, l), o && process.env.NODE_ENV !== "production" && U(), !0;
    }
    return !1;
  }, t.has = function(n) {
...
var xn = /* @__PURE__ */ Object.create(null), On = "remove", Rr = /* @__PURE__ */ function() {
  function e(r, n, i, a) {
  ...
  return t.getObservablePropValue_ = function(n) {
    ...
    if (i = a.prepareNewValue_(i), i !== p.UNCHANGED) {
      var s = W(this), l = process.env.NODE_ENV !== "production" && P(), c = s || l ? {
        type: Z,
      ...
      process.env.NODE_ENV !== "production" && l && z(c), a.setNewValue_(i), s && X(this, c), process.env.NODE_ENV !== "production" && l && U();
    }
    return !0;
  }, t.get_ = function(n) {
    return p.trackingDerivation && !H(this.target_, n) && this.has_(n), this.target_[n];
  }, t.set_ = function(n, i, a) {
    return a === void 0 && (a = !1), H(this.target_, n) ? this.values_.has(n) ? this.setObservablePropValue_(n, i) : a ? Reflect.set(this.target_, n, i) : (this.target_[n] = i, !0) : this.extend_(n, {
      value: i,
      enumerable: !0,
      writable: !0,
      configurable: !0
    ...
    return i || (i = new Se(n in this.target_, dr, process.env.NODE_ENV !== "production" ? this.name_ + "." + Vr(n) + "?" : "ObservableObject.key?", !1), this.pendingKeys_.set(n, i)), i.get();
    ...
    try {
      ...
      if (a) {
        ...
        _(this.target_, n, c);
      this.values_.set(n, new K(i)), this.notifyPropertyAddition_(n, void 0);
    } finally {
      q();
    }
    return !0;
  }, t.delete_ = function(n, i) {
    if (i === void 0 && (i = !1), Q(this.keysAtom_), !H(this.target_, n))
      return !0;
    if (M(this)) {
      var a = j(this, {
        object: this.proxy_ || this.target_,
    ...
    try {
      var o;
      R();
      var s = W(this), l = process.env.NODE_ENV !== "production" && P(), c = this.values_.get(n), d = void 0;
      if (!c && (s || l)) {
        var u;
        d = (u = Ht(this.target_, n)) == null ? void 0 : u.value;
      }
      if (i) {
      ...
      if (process.env.NODE_ENV !== "production" && delete this.appliedAnnotations_[n], c && (this.values_.delete(n), c instanceof Se && (d = c.value_), ji(c)), this.keysAtom_.reportChanged(), (o = this.pendingKeys_) == null || (o = o.get(n)) == null || o.set(n in this.target_), s || l) {
        ...
        process.env.NODE_ENV !== "production" && l && z(h), s && X(this, h), process.env.NODE_ENV !== "production" && l && U();
      }
    } finally {
      q();
    }
    ...
    var a, o = W(this), s = process.env.NODE_ENV !== "production" && P();
    if (o || s) {
      var l = o || s ? {
        type: pe,
        observableKind: "object",
      ...
      process.env.NODE_ENV !== "production" && s && z(l), o && X(this, l), process.env.NODE_ENV !== "production" && s && U();
    }
...
function et(e, t) {
  var r;
  if (process.env.NODE_ENV !== "production" && t && tt(e) && f("Options can't be provided for already observable objects."), H(e, g))
    return process.env.NODE_ENV !== "production" && !(ia(e) instanceof Rr) && f("Cannot convert '" + $t(e) + `' into observable object:
...
Extending builtins is not supported.`), e;
  ...
  var n = (r = t?.name) != null ? r : process.env.NODE_ENV !== "production" ? (D(e) ? "ObservableObject" : e.constructor.name) + "@" + F() : "ObservableObject", i = new Rr(e, /* @__PURE__ */ new Map(), String(n), qo(t));
  return lr(e, g, i), e;
}
var Is = /* @__PURE__ */ Ue("ObservableObjectAdministration", Rr);
function En(e) {
  return xn[e] || (xn[e] = {
    get: function() {
...
function Cn(e, t, r) {
  if (process.env.NODE_ENV !== "production" && !oa(t) && f("Cannot annotate '" + e.name_ + "." + r.toString() + "': Invalid annotation."), process.env.NODE_ENV !== "production" && !Xt(t) && H(e.appliedAnnotations_, r)) {
...
function ia(e, t) {
  if (e || f(29), Gr(e) || vr(e) || Yt(e) || be(e) || Y(e))
    return e;
  if (e[g])
    return e[g];
  f(24, e);
...
function qr(e, t, r, n, i) {
  ...
  if (n.push(e), i.push(t), s) {
    if (d = e.length, d !== t.length)
      return !1;
    for (; d--; )
      if (!qr(e[d], t[d], r - 1, n, i))
        return !1;
  } else {
    var u = Object.keys(e), h = u.length;
    if (Object.keys(t).length !== h)
      return !1;
    for (var v = 0; v < h; v++) {
      var m = u[v];
      if (!(H(t, m) && qr(e[m], t[m], r - 1, n, i)))
        return !1;
    }
  }
...
function Sn(e) {
  return gr(e) ? e.slice() : Qe(e) || be(e) || ne(e) || Y(e) ? Array.from(e.entries()) : e;
}
var Pn, Rs = ((Pn = Wr().Iterator) == null ? void 0 : Pn.prototype) || {};
function rn(e) {
...
const Bs = Symbol.for("react.portal"), Ks = Symbol.for("react.fragment"), Fs = Symbol.for("react.strict_mode"), Zs = Symbol.for("react.profiler"), Hs = Symbol.for("react.provider"), Ws = Symbol.for("react.context"), sa = Symbol.for("react.forward_ref"), Xs = Symbol.for("react.suspense"), Js = Symbol.for("react.suspense_list"), Gs = Symbol.for("react.memo"), Ys = Symbol.for("react.lazy");
function Qs(e, t, r) {
...
const Nt = async (e, t, r) => window.Vaadin.copilot.comm(e, t, r), ve = "copilot-", ll = "25.0.0-beta7", cl = "undefined", Td = "attention-required", Id = "https://plugins.jetbrains.com/plugin/23758-vaadin", zd = "https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode", Ud = "https://marketplace.eclipse.org/content/vaadin-tools";
function Ld(e) {
...
class yl {
  ...
  setPropertiesPanelState(t) {
    this.propertiesPanelState = t;
  }
  clearPropertiesPanelState() {
    this.propertiesPanelState = void 0;
  }
}
const wl = (e, t, r) => t >= e.left && t <= e.right && r >= e.top && r <= e.bottom, pa = (e) => {
  ...
  let r = e;
  for (; !(r instanceof HTMLElement && r.localName === `${ve}main`); ) {
    if (!r.isConnected)
      return null;
    if (r.parentNode)
      r = r.parentNode;
...
function fe(e) {
  if (e instanceof Node) {
    const t = pa(e);
    return e instanceof HTMLElement && t.push(e), t.map((r) => r.localName).some((r) => r.startsWith(ve));
  }
  return !1;
}
function In(e) {
...
var ha = /* @__PURE__ */ ((e) => (e["vaadin-combo-box"] = "vaadin-combo-box", e["vaadin-date-picker"] = "vaadin-date-picker", e["vaadin-dialog"] = "vaadin-dialog", e["vaadin-multi-select-combo-box"] = "vaadin-multi-select-combo-box", e["vaadin-select"] = "vaadin-select", e["vaadin-time-picker"] = "vaadin-time-picker", e["vaadin-popover"] = "vaadin-popover", e))(ha || {});
const Re = {
  "vaadin-combo-box": {
    hideOnActivation: !0,
    open: (e) => Ut(e),
  ...
  e.addEventListener("focusout", va, { capture: !0 }), ga(e), e.opened = !0;
}, Lt = (e) => {
  ma(e), e.removeAttribute("focused"), e.removeEventListener("focusout", va, { capture: !0 }), e.opened = !1;
}, ga = (e, t) => {
  const r = t ?? e.$.overlay;
...
class Vl {
  ...
  overlayStatus(t) {
    if (!t)
      return { visible: !1 };
    const r = t.localName;
    let n = Object.keys(ha).includes(r);
    if (!n)
      return { visible: !1 };
...
class zl {
  ...
  updatePanel(t, r) {
    ...
    if (i) {
      for (const a in r)
        i[a] = r[a];
      i.expanded && this.renderedPanels.add(i.tag), r.floating === !1 && (this._floatingPanelsZIndexOrder = this._floatingPanelsZIndexOrder.filter((a) => a !== t)), this._panels = n, He.savePanelConfigurations(this._panels);
    }
  }
  updateOrders(t) {
  ...
  removePanel(t) {
    ...
    r < 0 || (this._panels.splice(r, 1), He.savePanelConfigurations(this._panels));
  }
...
class Ll {
  ...
  addPaletteCustomComponent(t) {
    return (this.palette?.components ?? []).find((i) => Ar(i, t)) ? !1 : (this.palette || (this.palette = { components: [] }), this.palette = JSON.parse(JSON.stringify(this.palette)), this.palette.components.push(t), !0);
  }
  ...
  updatePaletteCustomComponent(t, r) {
    if (!this.palette || !this.palette.components)
      return;
    const n = [...this.palette.components], i = n.findIndex((a) => Ar(a, t));
...
window.Vaadin.copilot.eventbus = new Wa();
window.Vaadin.copilot.overlayManager = new Vl();
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Bt = globalThis, nn = Bt.ShadowRoot && (Bt.ShadyCSS === void 0 || Bt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, an = Symbol(), Bn = /* @__PURE__ */ new WeakMap();
let ya = class {
  constructor(t, r, n) {
  ...
  get styleSheet() {
    ...
    if (nn && t === void 0) {
      ...
      n && (t = Bn.get(r)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), n && Bn.set(r, t));
    }
    return t;
  }
  toString() {
...
const V = (e) => new ya(typeof e == "string" ? e : e + "", void 0, an), jl = (e, ...t) => {
...
}, Kn = nn ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ql, defineProperty: Bl, getOwnPropertyDescriptor: Kl, getOwnPropertyNames: Fl, getOwnPropertySymbols: Zl, getPrototypeOf: Hl } = Object, mr = globalThis, Fn = mr.trustedTypes, Wl = Fn ? Fn.emptyScript : "", Xl = mr.reactiveElementPolyfillSupport, ht = (e, t) => e, Fr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Wl : null;
      break;
...
Symbol.metadata ??= Symbol("metadata"), mr.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let Ke = class extends HTMLElement {
  ...
  static createProperty(t, r = Zn) {
    if (r.state && (r.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(t) && ((r = Object.create(r)).wrapped = !0), this.elementProperties.set(t, r), !r.noAccessor) {
      ...
      i !== void 0 && Bl(this.prototype, t, i);
    }
  }
  static getPropertyDescriptor(t, r, n) {
    const { get: i, set: a } = Kl(this.prototype, t) ?? { get() {
      return this[r];
    }, set(o) {
      this[r] = o;
    } };
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const i of n) r.unshift(Kn(i));
    } else t !== void 0 && r.push(Kn(t));
    return r;
  }
  static _$Eu(t, r) {
    const n = r.attribute;
...
Ke.elementStyles = [], Ke.shadowRootOptions = { mode: "open" }, Ke[ht("elementProperties")] = /* @__PURE__ */ new Map(), Ke[ht("finalized")] = /* @__PURE__ */ new Map(), Xl?.({ ReactiveElement: Ke }), (mr.reactiveElementVersions ??= []).push("2.1.0");
const qe = Symbol("LitMobxRenderReaction"), Hn = Symbol("LitMobxRequestUpdate");
function Jl(e, t) {
  var r, n;
  return n = class extends e {
    ...
    connectedCallback() {
      ...
      this[qe] = new t(`${a}.update()`, this[Hn]), this.hasUpdated && this.requestUpdate();
    }
    disconnectedCallback() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const on = globalThis, ar = on.trustedTypes, Wn = ar ? ar.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, xa = "$lit$", ue = `lit$${Math.random().toFixed(9).slice(2)}$`, Oa = "?" + ue, Yl = `<${Oa}>`, ze = document, Ot = () => ze.createComment(""), Et = (e) => e === null || typeof e != "object" && typeof e != "function", sn = Array.isArray, Ql = (e) => sn(e) || typeof e?.[Symbol.iterator] == "function", Sr = `[ 	
\f\r]`, ot = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xn = /-->/g, Jn = />/g, Oe = RegExp(`>|${Sr}(?:([^\\s"'>=/]+)(${Sr}*=${Sr}*(?:[^ 	
...
const _l = (e, t) => {
  ...
  for (let s = 0; s < r; s++) {
    const l = e[s];
    let c, d, u = -1, h = 0;
    for (; h < l.length && (o.lastIndex = h, d = o.exec(l), d !== null); ) h = o.lastIndex, o === ot ? d[1] === "!--" ? o = Xn : d[1] !== void 0 ? o = Jn : d[2] !== void 0 ? (Ea.test(d[2]) && (i = RegExp("</" + d[2], "g")), o = Oe) : d[3] !== void 0 && (o = Oe) : o === Oe ? d[0] === ">" ? (o = i ?? ot, u = -1) : d[1] === void 0 ? u = -2 : (u = o.lastIndex - d[2].length, c = d[1], o = d[3] === void 0 ? Oe : d[3] === '"' ? Yn : Gn) : o === Yn || o === Gn ? o = Oe : o === Xn || o === Jn ? o = ot : (o = Oe, i = void 0);
    const v = o === Oe && e[s + 1].startsWith("/>") ? " " : "";
    a += o === ot ? l + Yl : u >= 0 ? (n.push(c), l.slice(0, u) + xa + l.slice(u) + ue + v) : l + ue + (u === -2 ? s : v);
  }
    ...
    for (; (i = Ae.nextNode()) !== null && l.length < s; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const u of i.getAttributeNames()) if (u.endsWith(xa)) {
          const h = d[o++], v = i.getAttribute(u).split(ue), m = /([.?@])?(.*)/.exec(h);
          l.push({ type: 1, index: a, name: m[2], strings: v, ctor: m[1] === "." ? ec : m[1] === "?" ? tc : m[1] === "@" ? rc : br }), i.removeAttribute(u);
        ...
        if (Ea.test(i.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let v = 0; v < h; v++) i.append(u[v], Ot()), Ae.nextNode(), l.push({ type: 2, index: ++a });
            i.append(u[h], Ot());
          }
        }
...
vt._$litElement$ = !0, vt.finalized = !0, ln.litElementHydrateSupport?.({ LitElement: vt });
const sc = ln.litElementPolyfillSupport;
sc?.({ LitElement: vt });
(ln.litElementVersions ??= []).push("4.2.0");
class lc extends Gl(vt) {
}
class cc extends lc {
  constructor() {
...
function dc() {
  ke.push(import("./copilot-log-plugin-BxDZoP1i.js")), ke.push(import("./copilot-info-plugin-B0-1NrzW.js")), ke.push(import("./copilot-features-plugin-BKq22Xpx.js")), ke.push(import("./copilot-feedback-plugin-GkkiBGKS.js")), ke.push(import("./copilot-shortcuts-plugin-DfaRyZ1K.js"));
}
function uc() {
  {
...
const Be = window.Vaadin.copilot.overlayManager, $d = {
...
const hc = Sa(Zr), nt = window.Vaadin.copilot._machineState;
if (!nt)
...
function yc(e) {
  ...
  return b.setNotifications([...b.notifications, r]), (e.delay || !e.link && !e.dismissId) && setTimeout(() => {
    Da(r);
  }, e.delay ?? vc), y.emit("notification-shown", e), r;
}
const wc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  showNotification: Va
}, Symbol.toStringTag, { value: "Module" })), yr = window.Vaadin.copilot._earlyProjectState;
if (!yr)
...
function xc() {
  Nt(`${ve}plugin-restart-application`, {}, () => {
  }).catch((e) => {
    ce("Error restarting server", e);
  });
}
const Ta = window.Vaadin.copilot._previewState;
if (!Ta)
...
function ce(e, t) {
  const r = Pr(t) ? t.exceptionMessage ?? t.message : t, n = {
    type: ye.ERROR,
    message: "Copilot internal error",
    details: e + (r ? `
${r}` : "")
  };
  Pr(t) && t.suggestRestart && dn() && (n.details = ir(le`${e}<br />${r} ${cn()}`), n.delay = 3e4), Vt(n);
  let i;
  t instanceof Error ? i = t.stack : Pr(t) ? i = t?.exceptionStacktrace?.join(`
...
const Nc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  Vc().then((e) => b.setUserInfo(e)).catch((e) => ce("Failed to load userInfo", e));
}, Vc = async () => Nt(`${ve}get-user-info`, {}, (e) => (delete e.data.reqId, e.data));
...
const Ma = Symbol.for(""), Tc = (e) => {
  ...
  let l, c = 0, d = !1;
  for (; c < n; ) {
    for (l = t[c]; c < n && (a = r[c], (i = Tc(a)) !== void 0); ) l += i + t[++c], d = !0;
...
const { I: zc } = ic, eu = (e) => e.strings === void 0, ii = () => document.createComment(""), lt = (e, t, r) => {
  ...
  return r;
}, Ee = (e, t, r = e) => (e._$AI(t, r), e), Uc = {}, Lc = (e, t = Uc) => e._$AH = t, Mc = (e) => e._$AH, Dr = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const ai = (e, t, r) => {
  ...
  update(e, [t, r, n]) {
    ...
    const s = this.ut ??= [], l = [];
    let c, d, u = 0, h = i.length - 1, v = 0, m = a.length - 1;
    for (; u <= h && v <= m; ) if (i[u] === null) u++;
    else if (i[h] === null) h--;
    else if (s[u] === o[v]) l[v] = Ee(i[u], a[v]), u++, v++;
    else if (s[h] === o[m]) l[m] = Ee(i[h], a[m]), h--, m--;
    else if (s[u] === o[m]) l[m] = Ee(i[u], a[m]), lt(e, l[m + 1], i[u]), u++, m--;
    else if (s[h] === o[v]) l[v] = Ee(i[h], a[v]), lt(e, i[u], i[h]), h--, v++;
    else if (c === void 0 && (c = ai(o, v, m), d = ai(s, u, h)), c.has(s[u])) if (c.has(s[h])) {
      const O = d.get(o[v]), A = O !== void 0 ? i[O] : null;
      if (A === null) {
        const G = lt(e, i[u]);
        Ee(G, a[v]), l[v] = G;
      } else l[v] = Ee(A, a[v]), lt(e, i[u], A), i[O] = null;
      v++;
    } else Dr(i[h]), h--;
    else Dr(i[u]), u++;
    for (; v <= m; ) {
...
function od() {
  ...
  function e(t, r = 100, n = {}) {
    ...
    function d() {
      const v = a, m = o;
      return a = void 0, o = void 0, c = t.apply(v, m), c;
    }
    function u() {
      const v = Date.now() - l;
      v < r && v >= 0 ? s = setTimeout(u, r - v) : (s = void 0, i || (c = d()));
    }
    const h = function(...v) {
      if (a && this !== a && Object.getPrototypeOf(this) === Object.getPrototypeOf(a))
        throw new Error("Debounced method called with different contexts of the same prototype.");
      a = this, o = v, l = Date.now();
      const m = i && !s;
...
const li = new cd(), dd = "copilot-development-setup-user-guide";
function ou() {
  xt("use-dev-workflow-guide"), se.updatePanel(dd, { floating: !0 });
}
function Fa() {
  const e = yr.jdkInfo;
...
class fd {
  ...
  async includeFlowNode(t) {
    return pl(t) || Cr(t)?.hiddenByServer ? !1 : this.isInitializedInProjectSources(t);
  }
...
const hd = async () => {
  We && We.abort();
  const e = new fd();
  We = e, await e.init(), We = null, e.isAborted() || (window.Vaadin.copilot.tree.currentTree = e);
}, cu = () => {
  We && We.abort();
};
function vd() {
...
function bd(e) {
  const t = Br(e, "vaadin-context-menu-overlay");
  if (!t)
    return !1;
  const r = t.owner;
  return r ? !!Br(r, "copilot-component-overlay") : !1;
}
function yd() {
...
const fi = (e) => {
  ...
  if (!t)
    return;
  const r = bd(t);
  if (!(t.localName === "copilot-main") && !r && e.key !== "Escape") {
    e.stopPropagation();
    return;
  }
  let i = !0, a = !1;
  if (pi(e))
    ...
    if (b.loginCheckActive ? b.setLoginCheckActive(!1) : y.emit("close-drawers", {}), xd(t)) {
      e.stopPropagation();
      return;
    }
    y.emit("escape-key-pressed", { event: e });
  } else wd(e) ? (y.emit("delete-selected", {}), a = !0) : (e.ctrlKey || e.metaKey) && e.key === "d" ? (y.emit("duplicate-selected", {}), a = !0) : (e.ctrlKey || e.metaKey) && e.key === "b" ? (y.emit("show-selected-in-ide", { attach: e.shiftKey }), a = !0) : (e.ctrlKey || e.metaKey) && e.key === "z" && yd() ? (y.emit("undoRedo", { undo: !e.shiftKey }), a = !0) : pi(e) || y.emit("keyboard-event", { event: e });
  i && e.stopPropagation(), a && e.preventDefault();
}, wd = (e) => (e.key === "Backspace" || e.key === "Delete") && !e.shiftKey && !e.ctrlKey && !e.altKey && !e.metaKey;
function xd(e) {
  const t = e;
  if (Mn(e))
    return !0;
...
var Od = Object.getOwnPropertyDescriptor, Ed = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? Od(t, r) : t, a = e.length - 1, o; a >= 0; a--)
    (o = e[a]) && (i = o(i) || i);
  return i;
};
let hi = class extends cc {
  constructor() {
    super(...arguments), this.removers = [], this.initialized = !1, this.active = !1, this.overlayListener = (e) => {
      ...
      if (!e)
        return;
      const t = Br(e, "copilot-drawer-panel") ?? void 0;
      if (t)
        return t;
    }, this.toggleOperationInProgressAttr = () => {
      this.toggleAttribute("operation-in-progress", b.operationWaitsHmrUpdate !== void 0);
    }, this.operationInProgressCursorUpdateDebounceFunc = ld(this.toggleOperationInProgressAttr, 500), this.overlayOutsideClickListener = (e) => {
  ...
  async init() {
    if (this.initialized)
      return;
    await window.Vaadin.copilot._machineState.initializer.promise, await import("./copilot-global-vars-later-C3uReLMR.js"), await import("./copilot-init-step2-BYMBWu6y.js"), bl(), dc(), this.tabIndex = 0, Mt.hostConnectedCallback(), window.addEventListener("keydown", Hr), this.addEventListener("keydown", fi), y.onSend(this.handleSendEvent), this.removers.push(y.on("close-drawers", this.closeDrawers.bind(this))), this.removers.push(
    ...
    ), this.addEventListener("mousemove", this.mouseMoveListener), this.addEventListener("dragover", this.dragOverListener), this.addEventListener("dragleave", this.dragLeaveListener), this.addEventListener("drop", this.dropListener), Be.addOverlayOutsideClickEvent();
    ...
    ), He.getCopilotActivation() && ua().then(() => {
    ...
    t.observe(this), this.removers.push(() => {
      t.disconnect();
    }), za(), this.detectAppTheme(), this.initialized = !0, pd();
  }
  /**
   * Called when Copilot is activated. Good place to start attach listeners etc.
   */
  async activate() {
    Mt.activate(), li.copilotActivated(), pc(), this.openDrawerIfPanelRequiresAttention(), document.documentElement.addEventListener("mouseleave", this.mouseLeaveListener), Be.onCopilotActivation(), await hd(), Ta.loadPreviewConfiguration(), this.ensureTopmostPopover(), this.active = !0, nt.isActivationAnimation() && b.activatedFrom !== "restore" && this.getAllDrawers().forEach((e) => {
  ...
  deactivate() {
    ...
    }), this.closeDrawers(), Mt.deactivate(), li.copilotDeactivated(), document.documentElement.removeEventListener("mouseleave", this.mouseLeaveListener), Be.onCopilotDeactivation(), this.active = !1;
  }
  getAllDrawers() {
    return Array.from(this.shadowRoot.querySelectorAll("copilot-drawer-panel"));
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Mt.hostDisconnectedCallback(), window.removeEventListener("keydown", Hr), this.removeEventListener("keydown", fi), y.offSend(this.handleSendEvent), this.removers.forEach((e) => e()), this.removeEventListener("mousemove", this.mouseMoveListener), this.removeEventListener("dragover", this.dragOverListener), this.removeEventListener("dragleave", this.dragLeaveListener), this.removeEventListener("drop", this.dropListener), Be.removeOverlayOutsideClickEvent(), document.documentElement.removeEventListener("vaadin-overlay-outside-click", this.overlayOutsideClickListener), document.body.removeEventListener("vaadin-overlay-open", this.overlayListener), document.documentElement.removeEventListener("vaadin-overlay-close", this.overlayCloseEventListener);
  }
  handleSendEvent(e) {
  ...
  updated(e) {
    super.updated(e), this.attachActivationButtonToBody(), Wc();
  }
  ...
  detectAppTheme() {
    Vn("lumo") ? b.setAppTheme("lumo") : Vn("aura") ? b.setAppTheme("aura") : b.setAppTheme(null), Nt(`${ve}set-app-theme`, { theme: b.appTheme }, () => {
    });
  }
};
hi = Ed([
...
function pu(e, t, r) {
  return Ha(e, r).map((n) => Ad(n, t)).filter((n) => n !== void 0);
}
export {
  $c as $,
  jl as A,
