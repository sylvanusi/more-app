import { r as b, M as $, u as fe, v as N, b as h, j as l, C as X, w as p, x as m, y as oe, z as se, A as O, O as Pe, B as R, D as r, F as Y, G as pt, H as ht, I as ut, J as f, K as Z, L as ke, N as Se, E as g, Q as Fe, k as ae, l as Ve, P as Je, R as gt, V as ft, S as c, T as qe, U as E, W as vt, X as z, Y as k, Z as re, _ as We, $ as Ge, a0 as mt, a1 as de, a2 as bt, a3 as Ee, a4 as wt, a5 as yt, a6 as xt, a7 as Pt, a8 as Ye, a9 as It, aa as At, ab as $t, ac as Xe, ad as Ct, ae as kt, af as St, ag as Et, ah as Ke, ai as Rt, aj as Ie, ak as Ae, al as Dt } from "./copilot-wFV4RKYD.js";
import { n as y, r as x } from "./state-CZywSk--.js";
import { e as T } from "./query-BykXNUlT.js";
import { i as d } from "./icons-B-JB6Iy_.js";
import { c as Ze } from "./index-HNpFkLBf.js";
const Lt = 1, Re = 40, zt = 18;
function Mt(e, t) {
  if (e.length === 0)
    return;
  const i = _t(e, t);
...
const ce = "data-drag-initial-index", q = "data-drag-final-index";
let M = class extends $ {
  constructor() {
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.openedDescendantOverlayOwners = /* @__PURE__ */ new Set(), this.drawerDragLeaveListener = (e) => {
      const { x: t, y: i } = e;
      fe(this.getBoundingClientRect(), t, i) ? this.debounceHideDrawerWhenDragLeave.clear() : this.debounceHideDrawerWhenDragLeave();
      ...
      if (!fe(this.getBoundingClientRect(), t, i)) {
      ...
      this.getAllPanels().sort((t, i) => {
        ...
        if (t.setAttribute(q, `${i}`), t.panelTag !== this.draggingSectionPanel?.panelTag) {
          const n = Number.parseInt(t.getAttribute(ce), 10);
  ...
  cleanUpDragging() {
    this.draggingSectionPanel && (l.setSectionPanelDragging(!1), this.draggingSectionPanel.style.zIndex = "", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((e) => {
      e.style.removeProperty("transform"), e.removeAttribute(q), e.removeAttribute(ce);
...
var Ht = Object.defineProperty, Ut = Object.getOwnPropertyDescriptor, $e = (e, t, i, n) => {
...
let Q = class extends Y {
  constructor() {
    super(...arguments), this.checked = !1, this.documentMouseDownEventClickListener = (e) => {
      const t = pt([this]);
      fe(t, e.x, e.y) || (this.inputElement.blur(), document.removeEventListener("mousedown", this.documentMouseDownEventClickListener, { capture: !0 }));
    };
  }
  static get styles() {
    return O`
...
class jt {
  ...
  dragging(t, i) {
    const n = i.clientX, o = i.clientY, s = n - this.offsetX, a = n - this.offsetX + t.getBoundingClientRect().width, u = o - this.offsetY, w = o - this.offsetY + t.getBoundingClientRect().height;
    return this.adjust(t, s, u, a, w);
  }
  adjust(t, i, n, o, s) {
    let a, u, w, S;
    const L = document.documentElement.getBoundingClientRect().width, le = document.documentElement.getBoundingClientRect().height;
    return (o + i) / 2 < L / 2 ? (t.style.setProperty("--left", `${i}px`), t.style.setProperty("--right", ""), S = void 0, a = Math.max(0, i)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${L - o}px`), a = void 0, S = Math.max(0, L - o)), (n + s) / 2 < le / 2 ? (u = Math.max(0, n), t.style.setProperty("--top", `${u}px`), t.style.setProperty("--bottom", ""), w = void 0) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${le - s}px`), u = void 0, w = Math.max(0, le - s)), {
      left: a,
      right: S,
      top: u,
      bottom: w
...
function Ft(e, t) {
  if (!t)
    return !0;
  const [i, n, o] = t.split(".").map((w) => parseInt(w)), [s, a, u] = e.split(".").map((w) => parseInt(w));
  if (i < s)
    return !0;
  if (i === s) {
    if (n < a)
...
let I = class extends $ {
  ...
  renderPluginIsNotInstalledContent(e) {
    ...
    return e.intellij ? (t = gt, i = "Install from JetBrains Marketplace") : e.vscode ? (t = ft, i = "Install from VSCode Marketplace") : e.eclipse && (t = Se, i = "Install from Eclipse Marketplace"), r`
      <div>
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], ae(`${Je}set-up-vs-code-hotswap`, {}, (t) => {
...
let ze = class extends $ {
  ...
  render() {
    return r`
      <vaadin-icon .svg="${d.stars2}"></vaadin-icon>
      <span class="flex flex-col">
        <span
          >AI Provider:
          <span class="text-blue-11" id="ai-provider">
            ${c.getAIProvider() === "ANY" ? "Any" : c.getAIProvider() === "EU_ONLY" ? "Inside EU" : "???"}</span
          >
        </span>
...
let Me = class extends $ {
  ...
  render() {
    const t = qe(), { status: i, message: n } = t;
    let o = "", s = "", a = "";
...
function v(e) {
  return Qe("vaadin-menu-bar-item", e);
}
function pe(e) {
  return Qe("vaadin-context-menu-item", e);
}
function Qe(e, t) {
  const i = document.createElement(e);
  if (t.style && (i.className = t.style), t.noCheckmark && i.classList.add("no-checkmark"), t.icon)
  ...
  if (t.label) {
    ...
    const n = vt(t.component) ? t.component : document.createElement(t.component);
    i.append(n);
  }
  if (t.description) {
    const n = document.createElement("span");
  ...
  if (t.suffix)
    if (typeof t.suffix == "string") {
      ...
      i.append(ei(t.suffix.strings[0]));
  return i;
}
function ei(e) {
  if (!e) return null;
...
function et(e) {
  return ae("copilot-switch-user", { username: e }, (t) => t.data.error ? (z({ type: k.ERROR, message: "Unable to switch user", details: t.data.error.message }), !1) : !0);
}
var ti = Object.defineProperty, ii = Object.getOwnPropertyDescriptor, V = (e, t, i, n) => {
...
function oi() {
  ...
  return e.label = "Username to Switch To", e.style.width = "100%", e.autocomplete = "off", e.addEventListener("click", async (t) => {
    ...
    if (t.stopPropagation(), t.key === "Enter") {
      const i = e.value;
      await et(i) && (c.addRecentSwitchedUsername(i), window.location.reload());
    }
  }), e;
}
...
let G = class extends $ {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: i } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(i - this.initialMouseDownPosition.y) > ni;
      }
      this.dragging && (this.setSubMenuVisibility(!1), C.dragging(this, e));
  ...
  generateItems() {
    ...
    if (f.springSecurityEnabled) {
      ...
      i.push(
        ...o.map((s) => ({
          component: v({ component: si(s) }),
          action: async () => {
            await et(s) && window.location.reload();
          }
        }))
        ...
        children: [
            ...
            children: [
              {
                ...
                keepOpen: !0,
                action: (o) => {
                  c.setActivationShortcut(!c.isActivationShortcut()), he(o, c.isActivationShortcut());
                }
              },
              {
                component: v({
                ...
                keepOpen: !0,
                action: (o) => {
                  c.setActivationAnimation(!c.isActivationAnimation()), he(o, c.isActivationAnimation());
                }
              },
              {
                component: v({
                ...
                action: (o) => {
                  ...
                  a === "ask" ? s = "yes" : a === "no" ? s = "ask" : s = "no", c.setAIUsageAllowed(s), ai(o);
                }
              },
              {
              ...
              },
              {
                ...
                keepOpen: !0,
                action: (o) => {
                  c.setSendErrorReportsAllowed(!c.isSendErrorReportsAllowed()), he(o, c.isSendErrorReportsAllowed());
                }
              },
              { component: "hr" },
              {
          ...
          },
          {
            component: v({
              icon: d.vaadin,
              label: "Copilot",
              hint: c.isActivationShortcut() ? de.toggleCopilot : void 0,
...
function ai(e) {
  ...
  const i = t.querySelector("#ai-usage");
  if (!i) {
    console.error("No element found when setting switch value");
    return;
  }
...
function ri(e) {
  ...
  const i = t.querySelector("#ai-provider");
  if (!i) {
    console.error("No element found when setting switch value");
    return;
  }
...
function tt() {
  ...
  let t, i;
  return e === "ask" ? (t = "Always Ask", i = "text-blue-11") : e === "no" ? (t = "Disabled", i = "text-ruby-11") : (t = "Enabled", i = "text-teal-11"), `<span class="${i}" id="ai-usage">${t}</span>`;
}
function li() {
  return c.getAIProvider() === "ANY" ? "Any" : c.getAIProvider() === "EU_ONLY" ? "Inside EU" : "???";
}
var di = Object.defineProperty, ci = Object.getOwnPropertyDescriptor, J = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? ci(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && di(t, i, o), o;
};
const P = "resize-dir", ue = "floating-resizing-active";
let _ = class extends $ {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      let u = "";
      i < a ? o < a ? (u = "nw-resize", this.setAttribute(P, "top left")) : s < a ? (u = "sw-resize", this.setAttribute(P, "bottom left")) : (u = "col-resize", this.setAttribute(P, "left")) : n < a ? o < a ? (u = "ne-resize", this.setAttribute(P, "top right")) : s < a ? (u = "se-resize", this.setAttribute(P, "bottom right")) : (u = "col-resize", this.setAttribute(P, "right")) : s < a ? (u = "row-resize", this.setAttribute(P, "bottom")) : o < a && (u = "row-resize", this.setAttribute(P, "top")), u !== "" ? (this.rectangleBeforeResizing = this.getBoundingClientRect(), this.style.setProperty("--resize-cursor", u)) : (this.style.removeProperty("--resize-cursor"), this.removeAttribute(P)), this.toggleAttribute(ue, u !== "");
    }, this.floatingResizingMouseDownListener = (e) => {
      this.hasAttribute(ue) && e.button === 0 && (e.stopPropagation(), e.preventDefault(), this.rectangleBeforeResizing = this.getBoundingClientRect(), C.anchorLeftTop(this), this.floatingResizingStarted = !0, this.toggleAttribute("resizing", !0), l.setSectionPanelResizing(!0));
    }, this.floatingResizingMouseLeaveListener = () => {
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(ue), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(P), this.panelInfo != null && this.panelInfo.height != null && this.panelInfo?.height > window.innerHeight && (p.updatePanel(this.panelInfo.tag, {
      ...
      <vaadin-context-menu
        ...
        h.emit("vaadin-drawer-opened-changed", { opened: n, owner: i });
      }}"
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            l.operationInProgress === Pe.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging && !this.hasDropTarget()
          );
        });
      }
    ), this.reaction(
  ...
  setResizePosition(e, t, i) {
    const n = this.rectangleBeforeResizing, o = 0, s = window.innerWidth, a = 0, u = window.innerHeight, w = Math.max(o, Math.min(s, t)), S = Math.max(a, Math.min(u, i));
    if (e === "left")
    ...
    return this.panelInfo ? r`
      <div part="container">
        <div
          ...
          <h2 class="flex-1 my-0 overflow-hidden" id="${this.panelInfo.tag}-title" part="title">
            <vaadin-button
...
const me = window.Vaadin.copilot.customComponentHandler;
if (!me)
...
h.on("undoRedo", (e) => {
  const i = { files: hi(e), uiId: Pt() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", o = e.detail.undo ? "undo" : "redo";
  Ye(o), pi(Pe.RedoUndo), ae(n, i, (s) => {
    if (!s.data.performed) {
...
function hi(e) {
  ...
  const t = me.getActiveDrillDownContext();
  if (t) {
    const i = me.getCustomComponentInfo(t);
    if (i)
...
const mi = {
   ...
   */
  run(e) {
    we || (we = !0, queueMicrotask(() => vi())), j.push(e);
    const t = Ue;
    return Ue += 1, t;
  },
  /**
...
function bi(e) {
  this._$AN !== void 0 ? (ie(this), this._$AM = e, ot(this)) : this._$AM = e;
}
function wi(e, t = !1, i = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0) if (t) if (Array.isArray(n)) for (let s = i; s < n.length; s++) W(n[s], !1), ie(n[s]);
  else n != null && (W(n, !1), ie(n));
  else W(this, e);
}
const yi = (e) => {
  e.type == Ke.CHILD && (e._$AP ??= wi, e._$AQ ??= bi);
};
class xi extends St {
  constructor() {
  ...
  _$AT(t, i, n) {
    super._$AT(t, i, n), ot(this), this.isConnected = t._$AU;
  }
  _$AO(t, i = !0) {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const ge = Symbol("contentUpdateDebouncer");
class Ce extends Pi {
  /**
   ...
   */
  removeRenderer() {
    this.element[this.rendererProperty] = null, delete this.element[ge];
  }
}
class Ii extends Ce {
  get rendererProperty() {
...
const st = Ie(Ii), at = Ie(Ai), rt = Ie($i);
var Ci = Object.defineProperty, ki = Object.getOwnPropertyDescriptor, lt = (e, t, i, n) => {
...
lt([
  y()
], ye.prototype, "opened", 2);
ye = lt([
  b("copilot-ai-usage-confirmation-dialog")
], ye);
var Si = Object.defineProperty, Ei = Object.getOwnPropertyDescriptor, H = (e, t, i, n) => {
...
`)}`;
  ...
  submitErrorToGithub() {
    ...
    n.length >= 7500 && (Ze(i), n = encodeURIComponent("Please paste report here. It was automatically added to your clipboard."));
...
var Ri = Object.defineProperty, Di = Object.getOwnPropertyDescriptor, dt = (e, t, i, n) => {
...
h.on("endpoint-response", (e) => {
  ...
  )) : (i.details = `Error: ${n} ${zi(n)}`, i.type = k.ERROR), h.emit("update-log", {
    id: ct(e.detail),
    ...i
  });
});
...
var Mi = Object.defineProperty, _i = Object.getOwnPropertyDescriptor, U = (e, t, i, n) => {
